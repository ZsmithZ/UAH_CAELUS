...
% VRK1652 Comms vs Radar (LFM) - Comms Annotation in Mbps / KB (Updated for 32 Gsps ADC)
% ======================================================================================
...
n_tiles = 4;
adc_tile_rate_gsps = 32;  % ADC sampling rate per tile
enable_IQ = true;
...
sgtitle('VRK1652 Comms vs Radar (LFM) - Mbps / KB Annotation for Comms (32 Gsps)');
